...
export default function PrivacyPolicy() {
 ...
 <p>By executing secure payments via Razorpay, Vastra culture integrates API calls requiring data sharing matching the payment execution standard PCI DSS norms.</p>
 
 <h2 className="text-2xl text-white font-bold mt-8">3. Communication</h2>
 <p>Vastra culture Automated Notification handler will occasionally use your email format to SMS/Email delivery logs and tracking URLs. Opt-outs can be managed inside `/dashboard/settings`.</p>
 </div>
 }
 />
 );
