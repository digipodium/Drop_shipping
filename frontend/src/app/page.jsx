        ...
        <div>
            ...
            <section className="relative w-full h-[60vh] md:h-screen overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
                    ...
                    {/* Subtext */}
                    <p
                        className={`text-[10px] md:text-xs font-medium uppercase tracking-[0.4em] text-white/70 mb-4 transition-all duration-600 delay-200 ${isTransitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'
                            }`}
                    >
                    ...
                    {/* Heading */}
                    <h1
                        className={`text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold uppercase tracking-[0.15em] -mr-[0.15em] text-white mb-6 md:mb-8 drop-shadow-2xl transition-all duration-6 00 ${isTransitioning ? 'opacity-0 translate-y-6' : 'opacity-100 translate-y-0'
                            }`}
                    >
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex gap-3">
                    {heroSlides.map((_, index) => (
                        <button
                            ...
                            className={`h-[2px] transition-all duration-500 ${currentSlide === index ? 'w-10 bg-white' : 'w-5 bg-white/40 hover:bg-white/70'
                                }`}
