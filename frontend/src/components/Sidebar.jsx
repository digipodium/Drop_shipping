...
import { LayoutDashboard, Package, Users, ShoppingCart, LogOut, ShieldCheck, Settings, MessageSquare } from "lucide-react";
...
export default function Sidebar() {
 ...
 { name: "Feedback", href: `/admin/feedback`, icon: <MessageSquare className="w-5 h-5 text-blue-400" />, roles: ["admin"] },
