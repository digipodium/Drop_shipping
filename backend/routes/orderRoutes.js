...
router.post("/", authMiddleware, async (req, res) => {
 ...
 return res.status(400).json({ message: `Invalid product ID: ${item.product}. This item may be a placeholder and cannot be ordered.` });
 }
 ...
 totalPrice,
 isFastDelivery,
 status: "Forwarded" // : Automatically forwarded
 });
